(function () {
  ...
  const TOURS = [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1600263997535-e4f38ca66c3f?w=600&q=80',
      heroImage:
        'https://images.unsplash.com/photo-1600263997535-e4f38ca66c3f?w=1200&q=80',
      ...
      includes: [
        ...
        'Traditional lunch',
        'All transportation within city',
      ],
      excludes: [
        'Hotel pickup/dropoff outside Tirana',
        'Personal expenses',
        'Tips',
      ],
    ...
    },
    {
      ...
      badge: 'Best Seller',
      shortDescription:
        'Discover the UNESCO World Heritage city of Berat, famed for its stunning Ottoman architecture and hilltop castle.',
      fullDescription:
        "Step into a living museum as you explore Berat, one of the oldest cities in Albania and a UNESCO World Heritage Site. Known as the 'City of a Thousand Windows' for its distinctive Ottoman houses, Berat offers an unforgettable journey through centuries of history. From the imposing castle perched above the city to the charming Mangalem quarter, every corner tells a story.",
      image:
        'https://images.unsplash.com/photo-1580139648389-0f86fb839de2?w=600&q=80',
      heroImage:
        'https://images.unsplash.com/photo-1580139648389-0f86fb839de2?w=1200&q=80',
    ...
    },
    {
      ...
      badge: 'Popular',
      shortDescription:
        'Crystal-clear waters, hidden beaches, and the ancient ruins of Butrint along the stunning Albanian Riviera.',
      fullDescription:
        "Experience the breathtaking Albanian Riviera, where turquoise waters meet dramatic clifftops. This 3-day journey takes you from the vibrant coastal town of Saranda to the pristine beaches of Ksamil, the mystical Blue Eye Spring, and the ancient UNESCO site of Butrint. It's the perfect blend of relaxation and exploration.",
      image:
        'https://images.unsplash.com/photo-1586953135231-e4fde9b3a035?w=600&q=80',
      heroImage:
        'https://images.unsplash.com/photo-1586953135231-e4fde9b3a035?w=1200&q=80',
      ...
      itinerary: [
        ...
        {
          time: 'Day 3',
          activity: 'Blue Eye Spring, Mirror Beach & return',
        },
      ],
      includes: [
        'Licensed guide',
    ...
    },
    {
      ...
      badge: 'Adventure',
      shortDescription:
        "Hike the legendary Valbona-Theth trail through the Albanian Alps — one of Europe's best treks.",
      fullDescription:
        "The Valbona to Theth trek is the crown jewel of Albanian hiking. Crossing the stunning Valbona Pass at 1,795 meters, this trail offers jaw-dropping views of the Accursed Mountains. Combined with the spectacular Koman Lake ferry ride, traditional guesthouses, and the enchanting Blue Eye of Theth, this is an adventure you'll never forget.",
      image:
        'https://images.unsplash.com/photo-1564415637254-92c66292cd64?w=600&q=80',
      heroImage:
        'https://images.unsplash.com/photo-1564415637254-92c66292cd64?w=1200&q=80',
      ...
      itinerary: [
        {
          time: 'Day 1',
          activity: 'Koman Lake ferry to Fierza, drive to Valbona',
        },
      ...
      includes: [
        ...
        'All meals',
        'Koman ferry ticket',
        'Transport from Shkodra',
      ],
      excludes: [
        'Hiking gear',
        'Travel insurance',
        'Transport to Shkodra from Tirana',
      ],
    ...
    },
    {
      ...
      badge: null,
      shortDescription:
        'Explore 2,500 years of history at Butrint National Park, a UNESCO site amid stunning wetland scenery.',
      fullDescription:
      ...
      image:
        'https://images.unsplash.com/photo-1603228254119-e6a4d095dc59?w=600&q=80',
      heroImage:
        'https://images.unsplash.com/photo-1603228254119-e6a4d095dc59?w=1200&q=80',
    ...
    },
    {
      ...
      badge: 'Premium',
      shortDescription:
        "The ultimate coastal journey from Vlora to Ksamil along one of the Mediterranean's most beautiful drives.",
      fullDescription:
        "Embark on the ultimate Albanian coastal experience. Starting from Vlora, you'll traverse the breathtaking Llogara Pass with its panoramic views, descend to the pristine beaches of Dhermi and Himara, discover the Venetian fortress of Porto Palermo, and end at the paradise islands of Ksamil. This premium 5-day road trip covers the entire Albanian Riviera with handpicked seaside hotels and unforgettable experiences.",
      image:
    ...
    },
    {
      ...
      itinerary: [
        {
          time: 'Day 1 AM',
          activity: 'Tirana to Shkodra, Rozafa Castle visit',
        },
  ...
  const PRICING_TIERS = [
    { key: 'solo', label: '1 person', min: 1, max: 1 },
    { key: 'small', label: '2\u20134 people', min: 2, max: 4 },
    { key: 'medium', label: '5\u201310 people', min: 5, max: 10 },
    { key: 'large', label: '10+ people', min: 11, max: Infinity },
  ];
  ...
  function cacheDom() {
    ...
    DOM.pricingTableBody = document.getElementById('pricing-table-body');
  ...
  let currentPricingTour = TOURS[0].id;
  ...
  function renderTourCards(tours) {
    ...
    tours.forEach(function (tour, index) {
      ...
      card.setAttribute('data-duration', tour.duration);
      card.setAttribute('data-price', tour.pricing.solo);
      ...
      card.innerHTML =
        ...
        '<img src="' + tour.image + '" alt="' + tour.imageAlt + '" loading="lazy" width="400" height="267">' +
        badgeHtml +
        '<span class="tour-duration">' + createClockSVG() + ' ' + tour.durationLabel + '</span>' +
        '</div>' +
        '<div class="tour-card-body">' +
        '<div class="tour-card-meta">' +
        '<span class="tour-region">' + tour.region + '</span>' +
        '<span class="tour-rating">' + createStarSVG() + ' ' + tour.rating + '</span>' +
        '</div>' +
        ...
        '<span class="price-amount">$' + tour.pricing.large + '</span>' +
  ...
  function renderPricingTabs() {
    ...
    TOURS.forEach(function (tour) {
      ...
      tab.textContent = tour.title.split(':')[0];

      tab.addEventListener('click', function () {
        currentPricingTour = tour.id;
        updatePricingTabs();
        renderPricingTable(tour.id);
      });
  ...
  function updatePricingTabs() {
    DOM.pricingSelector.querySelectorAll('.pricing-tab').forEach(function (tab) {
      tab.setAttribute(
        'aria-selected',
        tab.getAttribute('data-tour-id') === currentPricingTour ? 'true' : 'false'
      );
    });
  }

  function renderPricingTable(tourId) {
    var tour = TOURS.find(function (t) { return t.id === tourId; });
    if (!tour) return;

    var soloPrice = tour.pricing.solo;

    DOM.pricingTableBody.innerHTML = PRICING_TIERS.map(function (tier, i) {
      var price = tour.pricing[tier.key];
      var savings =
        tier.key === 'solo'
          ? '\u2014'
          : 'Save ' + Math.round(((soloPrice - price) / soloPrice) * 100) + '%';

      var rowClass = i === 2 ? ' class="recommended-row"' : '';
      var popularBadge =
        i === 2 ? ' <span class="badge-popular">Most Popular</span>' : '';

      return (
        '<tr' + rowClass + '>' +
        '<td>' + tier.label + popularBadge + '</td>' +
        '<td class="price-cell">$' + price + '</td>' +
        '<td class="' + (tier.key !== 'solo' ? 'savings-cell' : '') + '">' + savings + '</td>' +
        '</tr>'
      );
    }).join('');
  }
  ...
  function applyFiltersAndSort() {
    ...
    switch (currentSort) {
      case 'price-low':
        filtered.sort(function (a, b) { return a.pricing.solo - b.pricing.solo; });
        break;
      case 'price-high':
        filtered.sort(function (a, b) { return b.pricing.solo - a.pricing.solo; });
        break;
      case 'duration-short':
  ...
  function openModal(tourId) {
    ...
    itineraryList.innerHTML = tour.itinerary
      .map(function (item) {
        return (
    ...
    // Book button — pre-select tour in form
  ...
  function getPriceTier(numPeople) {
    return PRICING_TIERS.find(function (tier) {
      return numPeople >= tier.min && numPeople <= tier.max;
    });
  }
  ...
  function updatePriceEstimate() {
    ...
    if (result) {
      DOM.estimateAmount.textContent =
        '$' + result.total + ' ($' + result.perPerson + '/person \u00d7 ' + people + ')';
      DOM.estimateAmount.classList.add('updated');
      setTimeout(function () {
        DOM.estimateAmount.classList.remove('updated');
      }, 400);
    }
  }
  ...
  function validateField(input) {
    ...
    var label = input.labels && input.labels[0]
      ? input.labels[0].textContent.replace(/\s*\*\s*/, '').trim()
      : input.name;
    ...
    if (input.required && !input.value.trim()) {
      ...
      if (num < 1 || num > 50) {
        message = 'Please enter between 1 and 50 people.';
      }
    }
  ...
  function init() {
    ...
    renderPricingTabs();
    renderPricingTable(currentPricingTour);
    populateTourSelect();
    initFilters();
    initModal();
    initForm();
